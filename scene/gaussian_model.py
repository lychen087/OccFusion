...
from utils.mesh_utils import decimate_mesh, clean_mesh, Mesh
...
class GaussianModel:
    ...
    def extract_fields(self, resolution=128, num_blocks=16, relax_ratio=1.5):
        ...
        covs = self.covariance_activation(stds, 1, self._rotation[mask], transform=None)
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        self.visbility = torch.zeros((fused_point_cloud.shape[0],), device="cuda")
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size, kl_threshold=0.4, t_vertices=None, iter=None, prune_only=False):
